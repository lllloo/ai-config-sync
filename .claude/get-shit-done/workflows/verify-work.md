...
Read and follow `D:/code/sync-ai/.claude/get-shit-done/workflows/transition.md`.
...
```bash
node "D:/code/sync-ai/.claude/get-shit-done/bin/gsd-tools.cjs" audit-open --json 2>/dev/null
```
