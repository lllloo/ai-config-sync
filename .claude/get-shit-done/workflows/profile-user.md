...
```bash
cp "D:/code/sync-ai/.claude/get-shit-done/USER-PROFILE.md" "D:/code/sync-ai/.claude/USER-PROFILE.backup.md"
```
...
```bash
BACKUP_PATH="D:/code/sync-ai/.claude/USER-PROFILE.backup.md"
```
