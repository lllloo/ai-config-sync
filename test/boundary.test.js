...
// safety:check 執行期依賴 sync.js + safety-check.js 兩檔，sandbox 需同時複製，
// 避免單檔假設回歸（sync.js require('./safety-check.js') 缺檔會直接崩）。
const SAFETY_RUNTIME_FILES = ['sync.js', 'safety-check.js'];
